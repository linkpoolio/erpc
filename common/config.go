...
type MetricsConfig struct {
	...
	// HistogramLabelMode controls label cardinality on duration histograms.
	// "detailed" (default): all labels (upstream, category, finality, user, composite)
	// "compact": collapses upstream, finality, user, composite to "n/a" — keeps only network + category
	HistogramLabelMode LabelMode `yaml:"histogramLabelMode,omitempty" json:"histogramLabelMode"`
}
